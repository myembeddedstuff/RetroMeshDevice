...
The goal is to build a completely independent, phone-free device using an ESP32-S3 and a custom 12-button T9 physical keypad (driven by an MCP23017 I/O expander).
